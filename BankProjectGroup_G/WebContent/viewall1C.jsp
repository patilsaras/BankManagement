...
$('#viewAllCust1').dataTable({"sPaginationType": "full_numbers",'iDisplayLength': 10 });
} );
</script>

<title>View All 1 C</title>
...
<center>
<table  id="viewAllCust1" class="display" border=4 bordercolor="black">
<thead>
<tr>
<td>CUSTOMER ID</td>
<td>SSN ID</td>
...
<tbody>
<%ArrayList<CustomerStatus> ac= (ArrayList<CustomerStatus>)request.getAttribute("view");%>
...
<td><a href="Controller?action=customerstatus">Refresh</a></td>
